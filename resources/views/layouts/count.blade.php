...
<div class="count resume">
    <img class="image" src="{{ env('HOSTED') ? '/public' : '' }}/icons/profiling.svg" alt="Profiling" height="280">
    <h2 class="total">Total {{ $resumes->count() === 1 ? 'Resume' : 'Resumes' }}: {{ $resumes->count() }}</h2>
</div>

<div class="count hire">
    <img class="image" src="{{ env('HOSTED') ? '/public' : '' }}/icons/hired.svg" alt="Profiling" height="280">
    <h2 class="total">Total hires: {{ $counts['hired'] }}</h2>
</div>

<div class="count interview">
    <img class="image" src="{{ env('HOSTED') ? '/public' : '' }}/icons/interview.svg" alt="Profiling" height="280">
    <h2 class="total">Total interviews: {{ $counts['interview'] }}</h2>
</div>

<div class="count apply">
    <img class="image" src="{{ env('HOSTED') ? '/public' : '' }}/icons/applied.svg" alt="Profiling" height="280">
    <h2 class="total">Total applications: {{ $counts['total'] }}</h2>
</div>

<div class="count other">
    <img class="image" src="{{ env('HOSTED') ? '/public' : '' }}/icons/other.svg" alt="Profiling" height="280">
